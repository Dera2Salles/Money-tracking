...
export function EmptyState({
  ...
  return (
    <FadeIn
      className={cn(
        "items-center justify-center px-8 py-12 relative",
        className,
      )}
    >
      {image ? (
      ...
      <Text className="font-ui text-ui-lg text-content-primary text-center mb-1 bottom-14">
        {title}
      </Text>
      {description && (
        <Text className="font-body-regular text-body-md text-content-secondary text-center max-w-[280px] bottom-14">
          {description}
        </Text>
      )}
